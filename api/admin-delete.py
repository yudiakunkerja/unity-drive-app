import os,json,sys;sys.path.append(os.path.dirname(__file__)+'/..')
...
def handler(r):
 ...
 if r.method!='DELETE':return(json.dumps({'error':'bad'}),405,h)
 try:
 ...
 except:print('err');return(json.dumps({'error':'fail'}),500,h)
